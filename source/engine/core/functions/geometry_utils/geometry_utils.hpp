...
class GeometryUtils
{
  public:
    ...
    ConvertWaveVertexToFloatArray(const std::vector<Wave::WaveVertex> &vertices)
    {
  ...
  public:
     ...
     * heightSegments: 1
     */
    static void CreatePlane(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
     ...
     * depthSegments: 1
     */
    static void CreateCube(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
     ...
     * thetaLength: PI
     */
    static void CreateSphere(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
     ...
     * thetaLength: 2 * PI
     */
    static void CreateCylinder(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
     ...
     * thetaLength: 2 * PI
     */
    static void CreateCone(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
     ...
     * arc: 2 * PI
     */
    static void CreateTorus(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
     ...
     * q: 3
     */
    static void CreateTorusKnot(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
