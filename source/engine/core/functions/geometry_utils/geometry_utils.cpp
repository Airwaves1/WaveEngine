...
namespace Wave
{
void GeometryUtils::CreatePlane(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
...
void GeometryUtils::CreateCube(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
...
void GeometryUtils::CreateSphere(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
...
void GeometryUtils::CreateCylinder(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
...
void GeometryUtils::CreateCone(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
...
void GeometryUtils::CreateTorus(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
...
void GeometryUtils::CreateTorusKnot(std::vector<WaveVertex> &vertices, std::vector<uint32_t> &indices,
